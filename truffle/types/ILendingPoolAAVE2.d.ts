...
export interface ILendingPoolAAVE2Contract
  extends Truffle.Contract<ILendingPoolAAVE2Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ILendingPoolAAVE2Instance>;
}

type AllEvents = never;

export interface ILendingPoolAAVE2Instance extends Truffle.ContractInstance {
  /**
